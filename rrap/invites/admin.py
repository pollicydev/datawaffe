...
class InviteAdmin(admin.ModelAdmin):
    ...
    list_select_related = ("invitee", "invited_by__profile", "organization")
    list_filter = ("status",)
    raw_id_fields = ("invitee", "invited_by", "organization")
    search_fields = (
        "invitee_email",
        "invitee__email",
        "invitee__username",
    ...
    fieldsets = (
        (None, {"fields": ("organization", "invited_by", "status", "code")}),
