...
(function () {
  ...
  var masonryGrid = (function () {
    ...
    var _loop = function _loop(i) {
      ...
      var filters = filtersWrap.querySelectorAll(
          ...
          pagination: {
            ...
            renderBullet: function renderBullet(index, className) {
              return "<li class='swiper-thumbnail "
                .concat(className, "'>\n              <img src='")
                .concat(images[index], "' alt='Thumbnail'>\n            </li>");
            },
          },
        });
      }
  ...
  var rangeSlider = (function () {
    ...
    var _loop3 = function _loop3(i) {
      ...
      var start = options.dataStartMax
  ...
  var inputAutoFocus = (function () {
    ...
    var _loop6 = function _loop6(i) {
      ...
      document
        ...
        .addEventListener("shown.bs.".concat(toggler[0]), function (e) {
          targetInput[i].focus();
        });
    };
  ...
  var priceSwitch = (function () {
    ...
    var showMonthlyPrice = function showMonthlyPrice(
      monthlyPrice,
      annualPrice
    ) {
    ...
    for (var i = 0; i < switchWrapper.length; i++) {
      var switchToggle = switchWrapper[i].querySelector(
        '[data-bs-toggle="price"]'
      );
      switchToggle.addEventListener("change", function (e) {
        var monthlySwitch = e.currentTarget.querySelector(
            "[data-monthly-switch]"
          ),
  ...
  var checkboxToggle = (function () {
    ...
    for (var i = 0; i < toggler.length; i++) {
      toggler[i].addEventListener("click", function (e) {
        e.preventDefault();
        var checkboxListContainer = document.querySelector(
