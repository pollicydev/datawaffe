...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["rrap.pollicy.org"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Rapid Research for Agile Policymaking <noreply@pollicy.org>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Rapid Research for Agile Policymaking]",
)
